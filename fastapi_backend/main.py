...
def recommend(req: Request):
    ...
    if "barn" in allowed and barn_ok:
        ...
        reason["barn"] = (
            ...
            "Needs Temperature < 35 degree Celcius, Rainfall < 4 mm, Max Temperature < 37 degree Celcius."
        )
        if season == "wet":
    ...
    if "ash/sawdust" in allowed and ash_ok:
        ...
        reason["ash/sawdust"] = "Needs Temperature ≥ 28 degree Celcius. Cut yam max: 14 days."
    ...
    if "ventilated crate" in allowed and crate_ok:
        ...
        reason["ventilated crate"] = "Needs Temperature 28-35 degree Celcius. Only for whole yam."
    ...
    if max_temp > 36:
        alerts.append("Heat-stress risk (>36 degree Celcius).")
