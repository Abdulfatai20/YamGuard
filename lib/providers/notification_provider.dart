...
// final notificationServiceProvider = Provider<ExpirationNotificationService>((
//   ref,
// ) {
...
// final weatherNotificationServiceProvider = Provider<WeatherNotificationService>(
//   (ref) {
...
// // Fixed notifications stream provider
// final notificationsStreamProvider = StreamProvider<List<NotificationItem>>((
//   ref,
// ) {
//   final firestore = ref.read(firestoreProvider);
//   final authService = ref.read(authServiceProvider);
...
//               .map((doc) {
//                 try {
//                   return NotificationItem.fromMap(doc.id, doc.data());
//                 } catch (e) {
...
// // Fixed unread notification count provider
