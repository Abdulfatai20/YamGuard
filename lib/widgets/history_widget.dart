        ...
        child: Column(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: firestore
                  .collection('expiredHarvests') // Direct query to expired items
                  .orderBy('expiryDate', descending: true) // Most recently expired first
                  .limit(10)
                  .snapshots(),
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Expired: ${DateFormat('MMM d, yyyy').format(expiryDate)}',
                                  style: TextStyle(
                                    fontSize: 14.0,
                                    fontWeight: FontWeight.w500,
                                    color: AppColors.secondary900,
